...
clear all
clc
addpath(genpath('C:\Users\students\Documents\Tugdual\GitHub\HMM-MAR')) 
DATA = load(strcat('C:\Users\students\Documents\Tugdual\PLOTS\Rat4\filtered_data'));
data = getfield(DATA, 'FINAL_DATA');
% data = [data{1};data{2}];
data = [data{1}]; % if only HPC
...
Hz = 600; % the frequency of the data
...
options_spectra.fpass = [1 200];  % band of frequency you're interested in
